...
class MinutestTestEngineTests {
    ...
    fun `selects tests by package`() {
        assertTestRun(
            ...
            "plan started",
            "started: Minutest",
            "started: ExampleMinutestInClass",
            ...
            "successful: ExampleMinutestInClass",
    ...
    fun `returns no tests if discovery request selects by method`() {
        ...
        assertTestRun(
            ...
            "plan started",
            "started: Minutest",
            "started: ExampleForMethodSelection",
            "registered: root1",
            "started: root1",
            "registered: a passing test",
            "started: a passing test",
            "successful: a passing test",
            "successful: root1",
            "successful: ExampleForMethodSelection",
            "successful: Minutest",
            "plan finished",
        )
    }
