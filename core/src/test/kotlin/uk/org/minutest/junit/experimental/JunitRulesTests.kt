    ...
    companion object {
        ...
        fun checkTestIsRun() {
            assertEquals(
                listOf(
                    "test 1",
                    "outer.apply rule fixture class.test 1(uk.org.minutest.junit.experimental.JunitRulesTests)",
                    "test 2",
                    "outer.apply rule test class.test 2(uk.org.minutest.junit.experimental.JunitRulesTests)"),
                log)
        }
    }
}
